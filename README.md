...
| 2 | **Recognition & Access** 🚗 | Nhận diện biển số, đối soát, điều khiển barie, quản lý payments | Bằng, Hùng *(repo riêng)* |
...
| 5 | **Payment** 💳 | Tạo hóa đơn, tích hợp thanh toán, lưu lịch sử giao dịch | Hùng |
| 6 | **UI & Analytics** 📊 | Dashboard user/admin, báo cáo, hệ thống cảnh báo | Tùng |
